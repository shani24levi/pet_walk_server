...
export const createPet = (_arr, i, dataLength) => {
  ...
  let pet = new PetClass("main .my_pets",_arr[i].img ,_arr[i].type ,_arr[i].name ,_arr[i].age, _arr[i].dayPlan ,_arr[i].activityLevel, _arr[i].foodLevel, i, _arr, dataLength);
